...
public static class Loc
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> _dictionaries = new()
    {
        ...
        {
            ["app.title"]        = "PDF Drive",
            ["app.subtitle"]     = "Сборка PDF, изображений и текста в один файл",
            ...
            ["btn.theme"]        = "🌓 Тема",
            ["list.empty"]       = "Список пуст. Нажмите «Добавить файлы» или перетащите PDF, изображения и текст сюда.",
            ...
            ["dlg.add.title"]    = "Выберите файлы (PDF, изображения, текст)",
            ["dlg.save.title"]   = "Сохранить итоговый PDF",
            ["dlg.savepdf.filter"] = "Файл PDF (*.pdf)|*.pdf",
            ["filter.supported"] = "Поддерживаемые файлы (PDF, изображения, текст)",
        ...
        {
            ["app.title"]        = "PDF Drive",
            ["app.subtitle"]     = "Combine PDFs, images and text into one file",
            ["btn.add"]          = "➕  Add files",
            ["btn.up"]           = "▲",
            ["btn.down"]         = "▼",
            ["btn.remove"]       = "✕",
            ...
            ["btn.theme"]        = "🌓 Theme",
            ["list.empty"]       = "List is empty. Click “Add files” or drag PDFs, images and text here.",
            ...
            ["dlg.add.title"]    = "Select files (PDF, images, text)",
            ["dlg.save.title"]   = "Save resulting PDF",
            ["dlg.savepdf.filter"] = "PDF file (*.pdf)|*.pdf",
            ["filter.supported"] = "Supported files (PDF, images, text)",
